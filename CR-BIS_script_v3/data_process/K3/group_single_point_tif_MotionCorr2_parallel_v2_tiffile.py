        ...
        for filename in all_files:
            if filename not in processed_files:
                ...
                if current_index + 1 < len(all_files):
                    ...
                    # If no new file appears for more than 1 minutes, process the last file and exit
                    if time.time() - last_activity_time > 60:  # 1 minutes in seconds
                        print(f"No new file detected for 1 minutes. Processing the last file: {filepath}.")
